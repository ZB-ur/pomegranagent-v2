...
Remixed by qubodup (cutting, noise removal, fade-in/out) from
**20130403_duck.04.wav**, by **dobroide**:
https://freesound.org/people/dobroide/sounds/185134/

Both current source pages display **CC BY 4.0**:
https://creativecommons.org/licenses/by/4.0/
The remixer's description also permits CC BY 3.0 or later.
No endorsement by either author is implied.
...
with 90 ms silence at the joining edge. Speech remains dynamically synthesized.
